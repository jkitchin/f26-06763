...
## Starting point
`l01-reproducibility.ipynb`, the notebook from Lecture 1 that does not reproduce. Download it from the course site (the download button on the notebook page, or the "Open in Colab" button if you would rather look at it there first).
